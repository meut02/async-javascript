...
function userupdatespost(){
    ...
    //Promise.all([ createPost({title:'Post two',body:'This is post two'}),updatelastactivitytime()]).then(([createPostresolves,updatelastactivitytimeresolves])=>{
       // console.log(updatelastactivitytimeresolves)
   // })
       Promise.all([createPost({title:'Post two',body:'This is post two',lastactivitytime:'2jan1993'}),updatelastactivitytime()]).then(getPosts)
